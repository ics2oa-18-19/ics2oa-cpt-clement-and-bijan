...
def update(delta_time):
    ...
    if current_screen == "play":
        ...
        for i, (x, y) in enumerate(zip(asteroid_x_positions_1, asteroid_y_positions_1)):
            a = x - (spaceship_x + 30)
            b = y - (spaceship_y + 30)
            ...
            if distance - 30 - 70 <= 0:
                lives -= 1
                del asteroid_x_positions_1[i]
                del asteroid_y_positions_1[i]

        for i, (x, y) in enumerate(zip(asteroid_x_positions_2, asteroid_y_positions_2)):
            a = x - (spaceship_x + 30)
            b = y - (spaceship_y + 30)
            distance = math.sqrt(a ** 2 + b ** 2)
            ...
            if distance - 30 - 30 <= 0:
                lives -= 1
                del asteroid_x_positions_2[i]
                del asteroid_y_positions_2[i]

        for i, (x, y) in enumerate(zip(asteroid_x_positions_3, asteroid_y_positions_3)):
            a = x - (spaceship_x + 30)
            b = y - (spaceship_y + 30)
            distance = math.sqrt(a ** 2 + b ** 2)
            ...
            if distance - 30 - 15 <= 0:
                lives -= 1
                del asteroid_x_positions_3[i]
                del asteroid_y_positions_3[i]
...
def on_key_press(key, modifiers):
    global current_screen, spaceship_x, spaceship_y, press_up, press_down, press_left, press_right, lives, time_passed
    if current_screen == "menu":
        if key == arcade.key.I:
